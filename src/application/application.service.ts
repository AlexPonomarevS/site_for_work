...
import { Section, StatusApplication } from '@prisma/client';
...
export class ApplicationService {
  ...
  async updateStatus(applicationId: number, status: string) {
    console.log('test after section');
    console.log(status);
    console.log('-----------------');
  ...
  async updateSection(applicationId: number, section: string) {
    console.log('test after section');
    console.log(section);
    console.log('-----------------');
    ...
    return this.prisma.getPrismaClient().application.update({
      where: { id: applicationId },
      data: { section: section as Section },
    });
  }
}
